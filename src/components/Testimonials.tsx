...
const testimonials = [
  {
    rating: 5,
    quote: "Very good Gym with Awesome facilities and equipment. Just had an amazing workout at the gym! 💪 The trainers are super knowledgeable, and the equipment is top-notch. Seriously, if you're thinking about joining, do it! The staff here is so friendly and always ready to help.",
  ...
  {
    rating: 5,
    quote: 'Excellent Gym, trainers are very good. Extremely neat and clean environment with almost all quality fitness equipment.',
  ...
  {
    rating: 5,
    quote: 'Good gym, neat and clean and has almost all fitness equipment required for all muscle groups.',
    author: 'Mridhulkrishna M',
    status: 'Regular Member',
